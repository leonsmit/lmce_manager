...
#
# == Synopsis
# Database Table: pluto_myth.psc_myth_tables
#
# * primary keys: PK_psc_myth_tables
# * foreign keys: 
# * external keys: 
#
# == References
...
#   * PK_psc_myth_tables    [Type:int(11), Default:NULL, Key:PRI, Null:NO, Extra:auto_increment]
...
class PlutoMyth::LmcePscMythTable < PlutoMythDatabase
  set_table_name "psc_myth_tables"
  set_primary_key "PK_psc_myth_tables"
