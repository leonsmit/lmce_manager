...
#
# == Synopsis
# Database Table: pluto_media.MediaType_MediaSubType
# Through Join Table
#
# * primary keys: EK_MediaType,FK_MediaSubType
# * foreign keys: FK_MediaSubType
...
#   * FK_MediaSubType    [Type:int(11), Default:0, Key:PRI, Null:NO]
...
class PlutoMedia::LmceMediaTypeMediaSubType < PlutoMediaDatabase
  set_table_name "MediaType_MediaSubType"
  set_primary_keys "EK_MediaType", "FK_MediaSubType"

  # foreign key references
  # FK_MediaType_MediaSubType references PlutoMedia::LmceMediaSubType (FK_MediaSubType)
  belongs_to  :lmce_media_sub_type,
      :class_name => "PlutoMedia::LmceMediaSubType",
      :foreign_key => "FK_MediaSubType"

  # external key references
  # EK_MediaType_MediaSubType references PlutoMain::LmceMediaType (EK_MediaType)
  belongs_to  :lmce_media_type,
