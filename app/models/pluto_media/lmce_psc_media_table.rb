...
#
# == Synopsis
# Database Table: pluto_media.psc_media_tables
#
# * primary keys: PK_psc_media_tables
# * foreign keys: 
# * external keys: 
#
# == References
...
#   * PK_psc_media_tables    [Type:int(11), Default:NULL, Key:PRI, Null:NO, Extra:auto_increment]
...
class PlutoMedia::LmcePscMediaTable < PlutoMediaDatabase
  set_table_name "psc_media_tables"
  set_primary_key "PK_psc_media_tables"
