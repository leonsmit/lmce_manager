...
#
# == Synopsis
# Database Table: pluto_media.File_Attribute
# Through Join Table
#
# * primary keys: FK_File,FK_Attribute,Track,Section
# * foreign keys: FK_File,FK_Attribute
# * external keys: 
#
# == References
...
class PlutoMedia::LmceFileAttribute < PlutoMediaDatabase
  set_table_name "File_Attribute"
  set_primary_keys "FK_File", "FK_Attribute", "Track", "Section"

  # foreign key references
  # FK_File_Attribute references PlutoMedia::LmceAttribute (FK_Attribute)
  belongs_to  :lmce_attribute,
      :class_name => "PlutoMedia::LmceAttribute",
      :foreign_key => "FK_Attribute"

  # FK_File_Attribute references PlutoMedia::LmceFile (FK_File)
  belongs_to  :lmce_file,
