...
#
# == Synopsis
# Database Table: pluto_telecom.psc_telecom_tables
#
# * primary keys: PK_psc_telecom_tables
# * foreign keys: 
# * external keys: 
#
# == References
...
#   * PK_psc_telecom_tables    [Type:int(11), Default:NULL, Key:PRI, Null:NO, Extra:auto_increment]
...
class PlutoTelecom::LmcePscTelecomTable < PlutoTelecomDatabase
  set_table_name "psc_telecom_tables"
  set_primary_key "PK_psc_telecom_tables"
