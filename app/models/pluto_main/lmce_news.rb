...
#
# == Synopsis
# Database Table: pluto_main.News
#
# * primary keys: PK_News
...
#   * PK_News         [Type:int(11), Default:0, Key:PRI, Null:NO]
#   * Date            [Type:date, Default:NULL, Null:YES]
#   * FK_Package      [Type:int(11), Default:NULL, Null:YES]
#   * Title           [Type:varchar(40), Default:NULL, Null:YES]
#   * ShortSummary    [Type:tinytext, Default:NULL, Null:YES]
#   * FullText        [Type:mediumtext, Default:NULL, Null:YES]
...
class PlutoMain::LmceNews < PlutoMainDatabase
  set_table_name "News"
  set_primary_key "PK_News"

  # foreign key references
  # FK_News references PlutoMain::LmcePackage (FK_Package)
  belongs_to  :lmce_package,
