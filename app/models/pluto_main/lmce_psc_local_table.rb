...
#
# == Synopsis
# Database Table: pluto_main.psc_local_tables
#
# * primary keys: PK_psc_local_tables
# * foreign keys: 
# * external keys: 
#
# == References
...
#   * PK_psc_local_tables    [Type:int(11), Default:NULL, Key:PRI, Null:NO, Extra:auto_increment]
...
class PlutoMain::LmcePscLocalTable < PlutoMainDatabase
  set_table_name "psc_local_tables"
  set_primary_key "PK_psc_local_tables"
