...
#
# == Synopsis
# Database Table: pluto_main.psc_website_tables
#
# * primary keys: PK_psc_website_tables
# * foreign keys: 
# * external keys: 
#
# == References
...
#   * PK_psc_website_tables    [Type:int(11), Default:NULL, Key:PRI, Null:NO, Extra:auto_increment]
...
class PlutoMain::LmcePscWebsiteTable < PlutoMainDatabase
  set_table_name "psc_website_tables"
  set_primary_key "PK_psc_website_tables"
