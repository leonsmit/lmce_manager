...
#
# == Synopsis
# Database Table: pluto_main.psc_document_tables
#
# * primary keys: PK_psc_document_tables
# * foreign keys: 
# * external keys: 
#
# == References
...
#   * PK_psc_document_tables    [Type:int(11), Default:NULL, Key:PRI, Null:NO, Extra:auto_increment]
...
class PlutoMain::LmcePscDocumentTable < PlutoMainDatabase
  set_table_name "psc_document_tables"
  set_primary_key "PK_psc_document_tables"
