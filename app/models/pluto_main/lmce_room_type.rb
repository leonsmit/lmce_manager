...
#
# == Synopsis
# Database Table: pluto_main.RoomType
#
# * primary keys: PK_RoomType
# * foreign keys: 
# * external keys: 
#
# == References
...
#   * PK_RoomType     [Type:int(11), Default:NULL, Key:PRI, Null:NO, Extra:auto_increment]
...
class PlutoMain::LmceRoomType < PlutoMainDatabase
