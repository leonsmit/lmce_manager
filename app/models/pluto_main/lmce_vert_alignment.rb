...
#
# == Synopsis
# Database Table: pluto_main.VertAlignment
#
# * primary keys: PK_VertAlignment
# * foreign keys: 
# * external keys: 
#
# == References
...
#   * PK_VertAlignment    [Type:int(11), Default:NULL, Key:PRI, Null:NO, Extra:auto_increment]
...
class PlutoMain::LmceVertAlignment < PlutoMainDatabase
  set_table_name "VertAlignment"
  set_primary_key "PK_VertAlignment"

  # foreign key references
  # 1:n  (FK_VertAlignment)
  has_many  :lmce_design_obj_variation_text_skin_languages,
