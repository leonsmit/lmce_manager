...
#
# == Synopsis
# Database Table: pluto_main.Image
#
# * primary keys: PK_Image
# * foreign keys: 
# * external keys: 
#
# == References
...
#   * PK_Image        [Type:varchar(100), Default:NULL, Key:PRI, Null:NO]
...
class PlutoMain::LmceImage < PlutoMainDatabase
  set_table_name "Image"
  set_primary_key "PK_Image"
