...
#
# == Synopsis
# Database Table: pluto_main.HorizAlignment
#
# * primary keys: PK_HorizAlignment
# * foreign keys: 
# * external keys: 
#
# == References
...
#   * PK_HorizAlignment    [Type:int(11), Default:NULL, Key:PRI, Null:NO, Extra:auto_increment]
...
class PlutoMain::LmceHorizAlignment < PlutoMainDatabase
  set_table_name "HorizAlignment"
  set_primary_key "PK_HorizAlignment"

  # foreign key references
  # 1:n  (FK_HorizAlignment)
  has_many  :lmce_design_obj_variation_text_skin_languages,
