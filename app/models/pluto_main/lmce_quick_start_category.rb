...
#
# == Synopsis
# Database Table: pluto_main.QuickStartCategory
#
# * primary keys: PK_QuickStartCategory
# * foreign keys: FK_QuickStartCategory_Parent
# * external keys: 
#
# == References
#
...
#   * PK_QuickStartCategory           [Type:int(11), Default:NULL, Key:PRI, Null:NO, Extra:auto_increment]
#   * FK_QuickStartCategory_Parent    [Type:int(11), Default:NULL, Null:YES]
...
# * has_many quick_start_category_parents
#

class PlutoMain::LmceQuickStartCategory < PlutoMainDatabase
  set_table_name "QuickStartCategory"
  set_primary_key "PK_QuickStartCategory"

  # foreign key references
  # 1:n  (FK_QuickStartCategory)
  has_many  :lmce_quick_start_templates,
  ...
  belongs_to  :parent,
      ...
      :foreign_key => "FK_QuickStartCategory_Parent"
  has_many  :quick_start_category_parents,
      :class_name => "PlutoMain::LmceQuickStartCategory",
      :foreign_key => "FK_QuickStartCategory_Parent"
