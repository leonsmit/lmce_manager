...
#
# == Synopsis
# Database Table: pluto_main.psc_ir_tables
#
# * primary keys: PK_psc_ir_tables
# * foreign keys: 
# * external keys: 
#
# == References
...
#   * PK_psc_ir_tables    [Type:int(11), Default:NULL, Key:PRI, Null:NO, Extra:auto_increment]
...
class PlutoMain::LmcePscIrTable < PlutoMainDatabase
  set_table_name "psc_ir_tables"
  set_primary_key "PK_psc_ir_tables"
