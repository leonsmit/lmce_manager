...
#
# == Synopsis
# Database Table: pluto_security.psc_security_tables
#
# * primary keys: PK_psc_security_tables
# * foreign keys: 
# * external keys: 
#
# == References
...
#   * PK_psc_security_tables    [Type:int(11), Default:NULL, Key:PRI, Null:NO, Extra:auto_increment]
...
class PlutoSecurity::LmcePscSecurityTable < PlutoSecurityDatabase
  set_table_name "psc_security_tables"
  set_primary_key "PK_psc_security_tables"
